/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 2e3690f62cfb2b79d4dd17bdbc7995ae)
// Runtime types generated with workerd@1.20250709.0 2025-07-11 nodejs_compat
...
declare namespace WebAssembly {
  ...
  class Global {
    constructor(descriptor: GlobalDescriptor, value?);
    value: any;
    valueOf(): any;
  }
  ...
  class Table {
    constructor(descriptor: TableDescriptor, value?);
    readonly length: number;
    get(index: number): any;
    grow(delta: number, value?): number;
    set(index: number, value?): void;
  }
...
declare function reportError(error): void;
