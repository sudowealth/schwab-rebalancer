...
function DemoSchwabOAuth() {
  ...
  const handleDeny = () => {
    ...
    console.log(
      "🔄 [DemoOAuth] Redirecting to callback with error:",
      callbackUrl
    );
    window.location.href = callbackUrl;
  };
          ...
          <CardContent className="space-y-4">
            ...
            <div className="border-t pt-4">
              <p className="text-sm text-muted-foreground mb-4">
                Would you like to authorize this demo application to access your
                simulated Schwab account data?
              </p>
            ...
            <div className="text-xs text-muted-foreground text-center">
              ⚠️ This is a demo environment. No real Schwab account will be
              accessed.
            </div>
          </CardContent>
        </Card>
