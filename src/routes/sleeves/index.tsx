    ...
    <div className="px-4 py-8">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <Button
                    size="sm"
                    variant="ghost"
                    onClick={() => handleDeleteSleeve(sleeve)}
                  >
      ...
      {sleeves.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Get started by seeding demo data.
          </p>
        </div>
      )}
      {/* Edit Modal */}
      ...
      {showSecurityModal &&
        ...
        (() => {
          ...
          const sp500Stock = sp500Data?.find(
                      ...
                      <div className="p-3 bg-blue-50 rounded-md">
                        ...
                        <div className="space-y-1 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-blue-900">
                              {sp500Stock.industry || "N/A"}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-blue-600">Sector:</span>
                            <span className="text-blue-900">
                              {sp500Stock.sector || "N/A"}
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-3 bg-green-50 rounded-md">
                        ...
                        <div className="space-y-1 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            >
                              {parseFloat(
                                position.dollarGainLoss?.replace(
                                  /[$,-]/g,
                                  ""
                                ) || "0"
                              ) >= 0
                    ...
                    {!sp500Stock &&
                      ...
                      (!recentTransactions ||
                        ...
                        <div className="text-center py-4 text-gray-500">
                          No additional information available for{" "}
                          {selectedTicker}
                        </div>
                      )}
                  </div>
