...
import { signUpWithFirstAdminServerFn, checkIsFirstUserServerFn, checkUserCreationAllowedServerFn } from "../lib/server-functions";
import { useQuery } from "@tanstack/react-query";
import { ShieldCheck, Crown, Ban, ArrowRight } from "lucide-react";
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    As the first user, you will automatically receive administrator privileges 
                    with full access to system management features.
                  </div>
                </div>
              </div>
            </div>
