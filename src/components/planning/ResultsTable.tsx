...
import { YearResult } from "~/lib/financial-planning-engine";
import { TaxDetailModal, TaxCalculationDetail } from "./TaxDetailModal";
  ...
  const tableData = useMemo(() => {
    return results.map((year) => ({
      ...
      contributions: {
        ...
        total:
          year.contributionsTaxable +
          year.contributionsRoth +
          year.contributionsDeferred,
      },
      withdrawals: {
        ...
        total:
          year.withdrawalsTaxable +
          year.withdrawalsRoth +
          year.withdrawalsDeferred,
      },
      taxes: {
  ...
  if (results.length === 0) {
    return (
      <div className="text-center py-12 text-gray-500">
        No results to display. Adjust your inputs to see the financial
        projection.
      </div>
    );
  }
      ...
      <div className="max-h-[600px] overflow-auto">
        ...
        <thead className="bg-gray-50 sticky top-0 z-10">
          ...
          <tr className="bg-gray-50">
            ...
            <th className="border border-gray-300 px-2 py-1 text-xs bg-blue-50">
              Taxable
            </th>
            <th className="border border-gray-300 px-2 py-1 text-xs bg-blue-50">
              Roth
            ...
            {/* Growth Sub-headers */}
            <th className="border border-gray-300 px-2 py-1 text-xs bg-green-50">
              Taxable
            </th>
            <th className="border border-gray-300 px-2 py-1 text-xs bg-green-50">
              Roth
            ...
            <th className="border border-gray-300 px-2 py-1 text-xs bg-emerald-50">
              Taxable
            </th>
            <th className="border border-gray-300 px-2 py-1 text-xs bg-emerald-50">
              Roth
            ...
            <th className="border border-gray-300 px-2 py-1 text-xs bg-amber-50">
              Taxable
            </th>
            <th className="border border-gray-300 px-2 py-1 text-xs bg-amber-50">
              Roth
            ...
            {/* Income Sub-headers */}
            <th className="border border-gray-300 px-2 py-1 text-xs bg-purple-50">
              Dividends
            </th>
            <th className="border border-gray-300 px-2 py-1 text-xs bg-purple-50">
              Cap Gains
            ...
            {/* Tax Sub-headers */}
            <th className="border border-gray-300 px-2 py-1 text-xs bg-red-50">
              Fed Income
            </th>
            <th className="border border-gray-300 px-2 py-1 text-xs bg-red-50">
              California
            ...
            <th className="border border-gray-300 px-2 py-1 text-xs bg-gray-50">
              Taxable
            </th>
            <th className="border border-gray-300 px-2 py-1 text-xs bg-gray-50">
              Roth
        ...
        <tbody>
          {tableData.map((row, index) => (
            ...
            >
              ...
              {/* Taxes */}
              <td
                className="border border-gray-300 px-2 py-1 text-xs text-right text-red-700 cursor-pointer hover:bg-red-50"
