...
import type { SP500Stock, Position, Transaction, Trade } from "../../lib/schemas";
              ...
              >
                ...
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span
                      className={
                        proposedTrade.canExecute ? "text-yellow-600" : "text-red-600"
                      }
                    >
                      Type:
                    </span>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs">
                          <span className="text-gray-900">
                            $
                            {(transaction.qty * transaction.price).toLocaleString(
                              "en-US",
                              { minimumFractionDigits: 2 }
                            )}
                          </span>
